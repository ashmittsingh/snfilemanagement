...
<body class="antialiased">
    <div class="relative min-h-screen w-full bg-[#B70F1D] flex overflow-hidden">
        ...
        <div
            ...
            <div
                class="w-full max-w-[380px] sm:max-w-[420px] lg:max-w-[460px] xl:max-w-[500px] bg-[#B70F1D] p-16 rounded-2xl">
                <h1 class="text-white font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-5xl mb-6 sm:mb-8 lg:mb-9">
                    Forgot Password</h1>
                <h3 class="text-white mb-6">Enter your email address and we'll <br> send you a link to reset your
                    password.</h3>
                ...
                <form id="formAuthentication" class="space-y-5 sm:space-y-6"
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="text" autocomplete="email" placeholder="Enter your email"
                            class="w-full rounded-lg border border-white text-white text-sm sm:text-base px-4 py-3.5 sm:py-4 outline-none focus:ring-2 focus:ring-white/50 transition" />
                        @error('email')
                    ...
                    <button type="submit" id="submitBtn"
                        class="w-full bg-white text-red-700 font-bold text-sm sm:text-base rounded-full py-3.5 sm:py-4 mt-1 hover:bg-red-50 active:scale-[0.99] shadow-lg transition">
                        <span id="btnText">
                    ...
                    <div class="flex justify-center text-white">
                        <p><i class="fa-solid fa-arrow-left"></i>&nbsp;<a href="{{ route('admin.login.view') }}">Back to
                                Login</a></p>
                    </div>
                </form>
            </div>
