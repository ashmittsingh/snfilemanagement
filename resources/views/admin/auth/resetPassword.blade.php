        ...
        <div
            ...
            <div class="w-full max-w-[380px] sm:max-w-[420px] lg:max-w-[440px] bg-[#B70F1D] px-16 py-16 lg:px-2 lg:py-2
                ...
                <form id="resetPasswordForm" class="space-y-5 sm:space-y-6"
                    ...
                    <div>
                        <label for="password" class="block text-white font-semibold text-sm sm:text-base mb-2">Confirm
                            Password <span class="text-danger">*</span></label>
                        ...
                        @error('password_confirmation')
                            <span class="error-msg">{{$message}}</span>
                        @enderror
                        <span class="error-msg" id="password_confirmation_error"></span>


                    </div>

                    <button type="submit" id="resetBtn"
                        class="w-full bg-white text-red-700 font-bold text-sm sm:text-base rounded-full py-3.5 sm:py-4 mt-1 hover:bg-red-50 active:scale-[0.99] shadow-lg transition">Reset</button>
                    <div></div>
...
<script>
    ...
    function togglePassword(fieldId, btn) {
        ...
        let eyeIcon = btn.querySelector("svg");
    ...
    <span style="margin-left:8px;">Resetting...</span>
`);
