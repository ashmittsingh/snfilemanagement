    ...
    <div class="error-msg type_error mt-1.5 text-xs text-red-600 font-medium hidden"></div>
            ...
            <div id="reelsUploadSection" class="mt-5">
                ...
                <label for="mediaFiles"
                    ...
                    <p id="uploadHint" class="text-sm sm:text-[15px] text-gray-700 font-medium">Please select a file type first</p>
                    <button type="button" disabled id="chooseFilesBtn" class="inline-flex items-center justify-center gap-2 bg-[#B70F1D] hover:bg-[#7A0F17] active:bg-[#650C13] disabled:bg-gray-300 disabled:cursor-not-allowed disabled:hover:bg-gray-300 text-white text-sm sm:text-[15px] font-semibold rounded-full px-6 py-2.5 sm:py-3 shadow-sm transition-colors my-2"><i class="fa-solid fa-folder-open"></i>Browse</button>
                </label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            */
            ...
            const uploadLabel = document.querySelector('label[for="mediaFiles"]');
...
function renderSelectedFiles() {
    ...
    if (!getCurrentFileRule()) {
        event.preventDefault();   // native file-dialog ko block karega
        return;
    }
