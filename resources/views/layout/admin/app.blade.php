...
<body class="bg-white text-gray-800 antialiased">
    <div class="flex min-h-screen w-full">
        ...
        <aside id="sidebar"
            class="bg-gradient-to-b from-[#C40F1E] to-[#B70F1D] h-screen w-64 fixed top-0 left-0 z-50 flex flex-col px-3 lg:px-4 py-5 lg:py-6 shrink-0 -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out shadow-xl">
            <div class="relative">
        ...
        <div class="flex-1 flex flex-col min-w-0 md:ml-64 lg:ml-64 bg-gray-200">
            <header
                class="flex items-center justify-between md:justify-end px-4 sm:px-6 lg:px-8 py-4 sm:py-6 fixed top-0 left-0 right-0 z-40 shadow-2xs shadow-gray-300 bg-white">
                ...
                <div class="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6">
                    ...
                    <div class="relative" id="profileWrapper">
                        <button id="profileButton" type="button"
                            class="flex items-center gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3 cursor-pointer outline-none"
                            ...
                            <div
                                ...
                                <i class="fa-solid fa-user text-[11px] sm:text-xs md:text-sm lg:text-sm">
                                </i>
                            </div>
                            <!-- <div>
                                <img src="{{ asset('admin_assets/images/' . Auth::user()->image) }}" alt="User avatar">
                            </div> -->

                            <span
                                class="hidden sm:inline text-xs md:text-sm lg:text-sm xl:text-base font-medium text-gray-700 whitespace-nowrap">
                                {{ ucfirst(Auth::user()->name) ?? 'N/A' }}
                            </span>
            ...
            <main class="flex-1 pb-10 mt-26 bg-gray-200">
                @yield('content')
            </main>
        </div>
    </div>
